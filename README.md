...
This repo is a forked repo of Flutter local_auth package to address the issue
https://github.com/flutter/flutter/issues/47465

There is actually already an existing PR but Google is slow to merge it
https://github.com/flutter/plugins/pull/2760

This repo is forked from the latest local_auth release, 0.6.3+4.  The commit SHA is e014c208909772cee2328a91b7225e667a2681a9
